...
save(kfoldcv, file="Revision 1 ecography/output//meta model/lmer_model_kfold.Rdata")

#fold n times (63 study IDs) leaving out 1 study each time 
kfoldcv_study<-cv(lmermod, clusterVariables="STUDY_ID") 
save(kfoldcv_study, file="Revision 1 ecography/output//meta model/lmer_model_kfoldstudy.Rdata")
...
#OTHER MODEL VERSIONS- NOT USING----
