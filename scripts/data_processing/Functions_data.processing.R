...
## Compute log proportion change of all abundance and biomass measures
...
get.log.prop.change<-function(x,data,pairs.keep){
  ...
  if (length(n)>1){
    ...
    for (x in 1:length(n)){
      ...
      #get mean abundances
      gen1.abun_mean<-study_1$mean_abun_st[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.abun_mean<-study_2$mean_abun_st[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      #get mean biomass
      gen1.bio_mean<-study_1$mean_bio_st[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.bio_mean<-study_2$mean_bio_st[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      
      
      
      #get sd abundances
      gen1.abun_sd<-study_1$sd_abun_st[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.abun_sd<-study_2$sd_abun_st[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      #get sd biomass
      gen1.bio_sd<-study_1$sd_bio_st[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.bio_sd<-study_2$sd_bio_st[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      
      
      
      #get median abundances
      gen1.abun_median<-study_1$median_abun_st[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.abun_median<-study_2$median_abun_st[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      #get median biomass
      gen1.bio_median<-study_1$median_bio_st[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.bio_median<-study_2$median_bio_st[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      
      
      
      #get average min 5% abundances
      gen1.abun_min5<-study_1$avg_abun_min_5perc[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.abun_min5<-study_2$avg_abun_min_5perc[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      #get average min 5% biomass
      gen1.bio_min5<-study_1$avg_bio_min_5perc[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.bio_min5<-study_2$avg_bio_min_5perc[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      
      
      
      #get average max 5% abundances
      gen1.abun_max5<-study_1$avg_abun_max_5perc[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.abun_max5<-study_2$avg_abun_max_5perc[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      #get average max 5% biomass
      gen1.bio_max5<-study_1$avg_bio_max_5perc[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.bio_max5<-study_2$avg_bio_max_5perc[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      
      
      
      #get average max 5% abundances
      gen1.abun_cov<-study_1$CoV_abun_st[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.abun_cov<-study_2$CoV_abun_st[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
      
      #get average max 5% biomass
      gen1.bio_cov<-study_1$CoV_bio_st[which(study_1$GENUS==genera.pair$Gn1 & study_1$YEAR%in%years.overlap)]
      gen2.bio_cov<-study_2$CoV_bio_st[which(study_2$GENUS==genera.pair$Gn2 & study_2$YEAR%in%years.overlap)]
