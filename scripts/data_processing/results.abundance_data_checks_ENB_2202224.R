...
hist(sampled_results_abundance$Abs.change.Gn1, breaks = 100)
...
#head_results_abundance <- head(results_abundance, 10000)
column_matrix <- t(matrix(head_results_abundance$Log.prop.change.Gn1, ncol = 74530))
...
pattern_test <- pairFreqs$pairs[5]
