...
To access all datasets for this homework, please create a version controlled Rproject from our Github repository here https://github.com/CIEE-Living-Data-Project/predicting_species_abundance. For more info on how to use Git through Rprojects see the Github_PREP tutorial attached to the homework email.  
