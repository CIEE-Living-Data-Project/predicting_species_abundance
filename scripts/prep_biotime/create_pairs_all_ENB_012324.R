...
# 3. Map pairs
# ADJUST TO ONLY WITHIN STUDIES 

# Author: Nathalie Chardon, Emily Black 
# Date created: 28 Nov 2022
# Date updated version created: 23 Jan 2024
...
# Identify pairs
coloc    <- data.table(which(m < sep.km | m == sep.km | m > sep.km, arr.ind=T))  # pairs of observations within critical separation distance
...
# Save dataframe
save(bio.pairs, file = 'data/prep_biotime/bio_pairs_all_ENB_012324.RData')
